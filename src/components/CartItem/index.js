...
const CartItem = props => (
  <CartContext.Consumer>
    {value => {
      ...
      return (
        <li className="cart-item" id="cartItem">
          <div className="cart-item-info" id="cartItem">
            <img src={imageUrl} alt={name} className="cart-item-image" />
            <h1 className="cart-item-desktop-name">{name}</h1>
          </div>
          <div className="cart-qty-price-cont" id="cartItem">
            ...
            <div className="cart-qty-container">
              ...
              <p id="item-quantity" className="item-quantity">
                {quantity}
              </p>
              <button
